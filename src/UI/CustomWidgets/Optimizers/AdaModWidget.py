...
class AdaModWidget(iw.VBox):

    name = "AdaMod Optimizer"
    ...
    def __init__(self, **kwargs):
        ...
        self.beta_3 = iw.BoundedFloatText(
            value=0.9995,
            min=0,
            max=1,
            step=0.005,
        ...
        super().__init__(children=[self.learning_rate, self.beta_1, self.beta_2, self.beta_3])
